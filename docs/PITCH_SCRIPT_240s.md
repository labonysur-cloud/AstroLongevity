# AstroLongevity: 30-Second Global Video Pitch Script

**Objective:** A compelling, high-energy 30-second script for the NASA Space Apps Challenge global nomination video. Must clearly state the problem, the NASA OSDR dataset used, the solution, and the impact. 

*Note: This script incorporates exact facts from NASA's "Counteracting Bone and Muscle Loss in Microgravity" article.*
